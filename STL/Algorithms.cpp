...
// if i want to get the maxvalue index 
// then
// int el=max_element(arr,arr+n)-arr;
// int el_1=min_element(arr,arr+n)-arr;
...
// you can simply get the index in vectors too
// auto el=max_element(v.begin(),v.end())-v.begin();
//auto el_1=min_element(v.begin(),v.end())-v.begin();
